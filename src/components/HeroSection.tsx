  ...
  return (
    <section id="hero" className="min-h-screen flex items-center justify-center relative font-comic bg-black overflow-hidden">
      ...
      <div className="container mx-auto px-4 text-center relative z-10 py-16">
        <div className="max-w-4xl mx-auto fade-in-up flex flex-col items-center justify-center min-h-[calc(100vh-100px)]">
          {/* Main Headline with 3D Effect */}
          <h1 className="text-5xl md:text-7xl font-bold text-white mb-6 leading-tight tracking-tight font-heading relative inline-block">
            <span className="relative z-10">Bennett University</span>
            <span className="block text-4xl md:text-6xl mt-2 text-white/90 font-heading relative z-10">
              Student Cabinet
            </span>
          </h1>

          <p className="text-xl md:text-2xl text-white/80 mb-10 max-w-2xl mx-auto font-light relative z-10">
            Leading with Vision. Serving with Purpose.
          </p>

          <p className="text-lg text-white/80 mb-12 max-w-3xl mx-auto relative z-10">
